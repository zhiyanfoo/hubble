...
# used by homebrew formula, which downloads tarball without git information.
hubble-without-git-info:
	$(GO) build $(if $(GO_TAGS),-tags $(GO_TAGS)) -ldflags "-w -s -X 'github.com/cilium/hubble/pkg.Version=${VERSION}'"
